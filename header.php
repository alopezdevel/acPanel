...
<div class="info_login">
    <div class="row">
        <div class="col-sm-9"><span><i class="fas fa-user"></i><?php echo $_SESSION["sUsuario"] ?></span>
        </div>
        <div class="col-sm-3"><span onclick="cpanelweb.logoff();"><i class="fas fa-sign-out-alt"></i> Salir</span></div>
    </div>
</div>